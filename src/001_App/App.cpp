    ...
    session_(appRoot() + "../dbo.db")
{
...
#ifdef DEBUG
    wApp->log("debug") << "App::App() - Application started ----------------jasdhflasjkdhflkajsdhf";
#endif
    // Title
    ...
    {// message resource bundle
        ...
        // wApp->messageResourceBundle().use("../../static/stylus-resources/xml/001_App/main");
        // wApp->messageResourceBundle().use("../../static/stylus-resources/xml/001_App/ovrwt");
        // wApp->messageResourceBundle().use("../../static/stylus-resources/xml/001_App/svg");
